# Angular Boot Camp example: example-binding-to-svg
...
**[StackBlitz for example-binding-to-svg](https://stackblitz.io/github/AngularBootCamp/example-binding-to-svg)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/example-binding-to-svg.git
cd example-binding-to-svg
npm install
npm start
```
